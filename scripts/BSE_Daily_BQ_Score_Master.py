...
def fetch_and_update_stock_data(symbol, total_symbol):
    try:
        ...
        log_message(f"BSE Life count: {current_counter} Fetching data for {symbol} ...")
...
BQ_DATASET = "bse_stock_score_master"  # Replace with your dataset name
BQ_TABLE = f"{PROJECT_ID}.{BQ_DATASET}.daily_bse_stock_master"  # Fully-qualified table name
