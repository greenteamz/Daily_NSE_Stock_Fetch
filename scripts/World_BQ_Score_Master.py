...
LOGS_DIR = os.path.join(BASE_DIR, "logs_world")
CSV_DIR = os.path.join(BASE_DIR, "csv_world")
...
ROW_COUNTER_FILE = os.path.join(MASTER_DIR, "world_row_counter.txt")
...
def fetch_and_update_stock_data(symbol, total_symbol):
    try:
        ...
        log_message(f"World Life count: {current_counter} Fetching data for {symbol} ...")
