...
sheet_base_name = f"Data_2023_to_{today}"
...
# Add a new sheet for the 2023 data
...
try:
    ...
    for symbol in symbols:
        ...
        data = yf.download(tickers=symbol, start=start_date, interval="1d", auto_adjust=True)
        if data.empty:
    ...
    print(f"Data from 2023 to today successfully added to the new worksheet titled '{sheet_name}'.")
